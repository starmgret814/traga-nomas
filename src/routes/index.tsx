...
function HomePage() {
  ...
  return (
    <main className="min-h-screen pb-32 md:pb-8 overflow-x-clip">
      {/* Header */}
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-[var(--background)]/80 border-b border-[var(--border)]/50">
        <div className="relative mx-auto max-w-md md:max-w-3xl lg:max-w-6xl px-4 py-4">
      ...
      <div className="mx-auto max-w-md md:max-w-3xl lg:max-w-6xl px-4">
        {/* Hero */}
        <section className="mt-6 grid lg:grid-cols-2 gap-8 lg:items-center">
          <div className="order-2 lg:order-1">
            ...
            <h1 className="mt-4 font-logo font-display font-extrabold leading-[0.85] text-[clamp(3.25rem,16vw,4.5rem)] md:text-7xl lg:text-8xl tracking-tight">
          ...
          <a
            href="#menu"
            className="order-1 lg:order-2 relative aspect-[4/3] sm:aspect-square w-full overflow-hidden rounded-3xl bg-[var(--card)] shadow-float group block"
          ...
          >
            ...
            {/* Floating "promo of the moment" pill */}
            <div className="absolute top-4 left-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--primary)] shadow-cta">
              <Flame className="w-4 h-4 text-[var(--primary-foreground)]" />
              <span className="font-display font-bold text-xs tracking-widest uppercase text-[var(--primary-foreground)]">
                Promo del momento
              </span>
            </div>
          ...
          <div key={activeCat} className="mt-4 space-y-8">
            {groupedProducts.map((group, groupIdx) => (
              <section key={group.category}>
                ...
                <div className="font-montserrat font-medium grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
